...
Source0  : https://download.kde.org/stable/plasma/6.0.2/kglobalacceld-6.0.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.2/kglobalacceld-6.0.2.tar.xz.sig
...
%prep
%setup -q -n kglobalacceld-6.0.2
cd %{_builddir}/kglobalacceld-6.0.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711665464
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKGlobalAccelD.so.6.0.2
