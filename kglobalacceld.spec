...
Source0  : https://download.kde.org/stable/plasma/6.3.5/kglobalacceld-6.3.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.5/kglobalacceld-6.3.5.tar.xz.sig
...
%setup -q -n kglobalacceld-6.3.5
cd %{_builddir}/kglobalacceld-6.3.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747238566
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKGlobalAccelD.so.6.3.5
