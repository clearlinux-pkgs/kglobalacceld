...
Source0  : https://download.kde.org/stable/plasma/6.1.1/kglobalacceld-6.1.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.1/kglobalacceld-6.1.1.tar.xz.sig
...
%setup -q -n kglobalacceld-6.1.1
cd %{_builddir}/kglobalacceld-6.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719438430
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKGlobalAccelD.so.6.1.1
