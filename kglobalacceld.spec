...
Source0  : https://download.kde.org/stable/plasma/6.3.3/kglobalacceld-6.3.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.3/kglobalacceld-6.3.3.tar.xz.sig
...
%setup -q -n kglobalacceld-6.3.3
cd %{_builddir}/kglobalacceld-6.3.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742543437
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKGlobalAccelD.so.6.3.3
