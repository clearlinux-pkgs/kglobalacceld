...
Source0  : https://download.kde.org/stable/plasma/6.1.0/kglobalacceld-6.1.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.0/kglobalacceld-6.1.0.tar.xz.sig
...
%setup -q -n kglobalacceld-6.1.0
cd %{_builddir}/kglobalacceld-6.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718832734
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKGlobalAccelD.so.6.1.0
