...
Source0  : https://download.kde.org/stable/plasma/6.3.2/kglobalacceld-6.3.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.2/kglobalacceld-6.3.2.tar.xz.sig
...
%setup -q -n kglobalacceld-6.3.2
cd %{_builddir}/kglobalacceld-6.3.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741277060
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKGlobalAccelD.so.6.3.2
