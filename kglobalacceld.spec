...
Version  : 6.4.0
Release  : 27
URL      : https://download.kde.org/stable/plasma/6.4.0/kglobalacceld-6.4.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.4.0/kglobalacceld-6.4.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.4.0/kglobalacceld-6.4.0.tar.xz.sig
...
%setup -q -n kglobalacceld-6.4.0
cd %{_builddir}/kglobalacceld-6.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750198432
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKGlobalAccelD.so.6.4.0
