...
Version  : 6.2.4
Release  : 18
URL      : https://download.kde.org/stable/plasma/6.2.4/kglobalacceld-6.2.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.2.4/kglobalacceld-6.2.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.4/kglobalacceld-6.2.4.tar.xz.sig
...
%setup -q -n kglobalacceld-6.2.4
cd %{_builddir}/kglobalacceld-6.2.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735334398
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKGlobalAccelD.so.6.2.4
